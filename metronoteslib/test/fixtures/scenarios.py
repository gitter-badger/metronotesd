...
UNITTEST_FIXTURE = [
    ...
    ['order', (ADDR[0], 'XMN', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['send', (ADDR[0], ADDR[1], 'DIVISIBLE', DP['quantity']), {'encoding': 'multisig'}],
    ['send', (ADDR[0], ADDR[1], 'XMN', DP['quantity']), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'XMN', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'XMN', DP['quantity'], 'BTC', round(DP['quantity'] / 100), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'BTC', round(DP['quantity'] / 150), 'XMN', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ['send', (ADDR[0], MULTISIGADDR[0], 'XMN', DP['quantity'] * 3), {'encoding': 'multisig'}],
    ...
    ['order', (ADDR[0], 'XMN', DP['quantity'], 'BTC', round(DP['quantity'] / 125), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[1], 'BTC', round(DP['quantity'] / 125), 'XMN', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ...
    ['send', (ADDR[2], ADDR[3], 'XMN', 92945878046), {'encoding': 'multisig'}],
...
def generate_standard_scenario(address1, address2, order_matches, rps_matches):
    ...
    return [
        ...
        ['send', (address1, address2, 'XMN', DP['small']), {'encoding': 'multisig'}],
        ['order', (address1, 'BTC', DP['small'], 'XMN', DP['small'] * 2, DP['expiration'], 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
        ['order', (address1, 'XMN', round(DP['small'] * 2.1), 'BTC', DP['small'], DP['expiration'], DP['fee_required']), {'encoding': 'multisig'}],
        ...
        ['dividend', (address1, 600, 'BBBB', 'XMN'), {'encoding': 'multisig'}],
        ['dividend', (address1, 800, 'BBBC', 'XMN'), {'encoding': 'multisig'}],
        ...
        ['order', (address1, 'BBBB', DP['small'], 'XMN', DP['small'], DP['expiration'], 0), {'encoding': 'multisig'}],
